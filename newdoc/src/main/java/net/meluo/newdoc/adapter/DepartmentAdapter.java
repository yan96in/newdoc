...
public class DepartmentAdapter extends BaseAdapter {
    ...
    DocRoomMainFragment fragment;

    // 构造函数
    public DepartmentAdapter(DocRoomMainFragment fragment,
                             ArrayList<Catalog> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.item_department, null);
