...
public final class MeDocFragment extends BaseFragment {
	...
	ArrayList<Doc> listDoc = new ArrayList<Doc>();

	public static MeDocFragment newInstance() {

		MeDocFragment fragment = new MeDocFragment();
		return fragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		layout = (RelativeLayout) inflater.inflate(R.layout.f_me_doc, null);
	...
	protected void initView(RelativeLayout root) {
		...
		mDocAdapter = new DocAdapter(this.getActivity(), listDoc,
				R.id.ami_content);
	...
	private void refresh() {
		...
		listDoc.clear();
		Ion.with(mContext,
				PreferenceConstants.BASE_URL + "/1/Focus?action=index")
