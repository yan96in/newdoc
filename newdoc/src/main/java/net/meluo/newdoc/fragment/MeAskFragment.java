...
public final class MeAskFragment extends BaseFragment {
	...
	public static MeAskFragment newInstance() {
		...
		MeAskFragment fragment = new MeAskFragment();
		return fragment;
	}
	...
	protected void initView(RelativeLayout root) {
		...
		mQuestionAdapter = new QuestionAdapter(this, listQuestion, 1);
