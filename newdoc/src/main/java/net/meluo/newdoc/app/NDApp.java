...
public class NDApp extends MultiDexApplication {
    ...
    public synchronized static NDApp getInstance() {
        return mApplication;
    }
    ...
    public void onCreate() {
       ...
       // Ion.getDefault(this).proxy("192.168.1.41", 51003);
        initData();
        ...
        // 初始化微信SDK
        api = WXAPIFactory.createWXAPI(this, PreferenceConstants.WX_APP_ID,
                true);
        api.registerApp(PreferenceConstants.WX_APP_ID);
    ...
    private void initData() {
        File dir = new File(Environment.getExternalStorageDirectory()
                .getAbsolutePath() + File.separator + "_newdoc");
        if (!dir.exists())
            dir.mkdir();
